...
4. Chỉnh sửa các biến môi trường phù hợp: tham khảo [task 6](https://www.cloudskillsboost.google/course_templates/674/labs/586883)
   Thực hiện edit and redeploy, tab Secret and Variable
...
Kiểm tra log và check bảng bằng truy vấn sau:

```
bq query "SELECT * FROM invoice_parser_results.doc_ai_extracted_entities"
```
